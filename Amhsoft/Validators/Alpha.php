 ...
 *
 * $Id: Alpha.php 102 2016-01-25 21:55:57Z a.cherif $
 * $Rev: 102 $
 * @package    AMHSHOP
 ...
 * @author cherif
 */
class Amhsoft_Alpha_Validator extends Amhsoft_Abstract_Validator {
    ...
    public function isValid() {
        ...
        return (boolean) preg_match('/^[a-zA-Z0-9_]+$/i', $this->_value);
