 ...
 *
 * $Id: Http.php 102 2016-01-25 21:55:57Z a.cherif $
 * $Rev: 102 $
 * @package    offer
  ...
  public function execute($target = '', $referrer = '', $method = '', $data = array()) {
    ...
    if ($this->useCurl) {
      ...
      if (($this->status == '301' || $this->status == '302') && $this->redirect == TRUE) {
        ...
        if ((isset($this->headers['transfer-encoding']) && $this->headers['transfer-encoding'] == 'chunked') || (isset($this->headers['content-transfer-encoding']) && $this->headers['content-transfer-encoding'] == 'chunked')) {
