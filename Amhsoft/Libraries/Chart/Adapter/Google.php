 ...
 *
 * $Id: Google.php 102 2016-01-25 21:55:57Z a.cherif $
 * $Rev: 102 $
 * @package    AMHSHOP
 ...
 * @author cherif
 */
class Amhsoft_Chart_Google_Adapter {
    ...
    private function textEncodeData($data) {
        ...
        $encodedData = array();
        $max = Amhsoft_Chart_Google_Adapter::getMaxOfArray($data);
        if ($max > 100) {
            $rate = $max / 100;
    ...
    public function getImgCode() {
        $code = '<img src="';
        $code .= $this->getUrl() . '"';
        $code .= 'alt="Amhsoft_Chart_Google_AdapterPhp Chart" width=' . $this->width . ' height=' . $this->height . '>';
        print($code);
    }
...
class gPieChart extends Amhsoft_Chart_Google_Adapter {
...
class gLineChart extends Amhsoft_Chart_Google_Adapter {
...
class gBarChart extends Amhsoft_Chart_Google_Adapter {
...
class gVennDiagram extends Amhsoft_Chart_Google_Adapter {
...
class gFormula extends Amhsoft_Chart_Google_Adapter {
    ...
    public function getImgCode() {
        $code = '<img src="';
        $code .= $this->getUrl() . '"';
        $code .= 'alt="Amhsoft_Chart_Google_AdapterPhp Chart"';
        if ($this->width)
...
class gQRCode extends Amhsoft_Chart_Google_Adapter {
...
class gMeterChart extends Amhsoft_Chart_Google_Adapter {
...
class gMapChart extends Amhsoft_Chart_Google_Adapter {
...
class gScatterChart extends Amhsoft_Chart_Google_Adapter {
