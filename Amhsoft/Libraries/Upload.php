    ...
    if ($this->processed) {
      ...
      if (!$return_mode) {
        if (!$this->file_auto_rename) {
          ...
          $this->file_dst_pathname = $this->file_dst_path . $this->file_dst_name_body."_1.".$this->file_dst_name_ext;//$this->file_dst_name;
...
class Amhsoft_Upload extends upload{
