 ...
 *
 * $Id: UnZip.php 102 2016-01-25 21:55:57Z a.cherif $
 * $Rev: 102 $
 * @package    Core
...
class Amhsoft_Compress_UnZip{
  ...
  // Public
  public function Amhsoft_Compress_UnZip($fileName=null){
    if($fileName != null){
      $this->open($fileName);
  ...
  public function read($compressedFileName){
    $file = './cache/manifest.xml';
    $this->unzip($compressedFileName, $file);
    if(file_exists($file)){
