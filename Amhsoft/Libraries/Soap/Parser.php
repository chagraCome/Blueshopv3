 ...
 * $Author: a.cherif $
 */
class Amhsoft_Soap_Parser extends nusoap_base {
   ...
   * @access   public
   */
  function Amhsoft_Soap_Parser($xml,$encoding='UTF-8',$method='',$decode_utf8=true){
    parent::nusoap_base();
    $this->xml = $xml;
    ...
    if(!empty($xml)){
      ...
      $this->debug('Entering Amhsoft_Soap_Parser(), length='.strlen($xml).', encoding='.$encoding);
 ...
 */
class soap_parser extends Amhsoft_Soap_Parser {
}
