 ...
 * $Author: a.cherif $
 */
class Amhsoft_Soap_Client extends nusoap_base  {
   ...
   * @access   public
   */
  function Amhsoft_Soap_Client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
    parent::nusoap_base();
  ...
  function _getProxyClassCode($r) {
    ...
    $evalStr = 'class nusoap_proxy_'.$r.' extends Amhsoft_Soap_Client {
	'.$evalStr.'
}';
    return $evalStr;
  }
...
if (!extension_loaded('soap')) {
   ...
   */
  class soapclient extends Amhsoft_Soap_Client {
  }
}
?>
