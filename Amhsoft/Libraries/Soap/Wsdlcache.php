 ...
 *
 * $Id: Wsdlcache.php 102 2016-01-25 21:55:57Z a.cherif $
 * $Rev: 102 $
 * @package    Core
...
class Amhsoft_Soap_Wsdlcache {
   ...
   * @access public
   */
  function Amhsoft_Soap_Wsdlcache($cache_dir='.', $cache_lifetime=0) {
    $this->fplock = array();
 ...
 */
class wsdlcache extends Amhsoft_Soap_Wsdlcache {
}
?>
