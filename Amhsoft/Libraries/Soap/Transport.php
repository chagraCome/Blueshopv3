 ...
 *
 * $Id: Transport.php 102 2016-01-25 21:55:57Z a.cherif $
 * $Rev: 102 $
 * @package    Core
 ...
 * $Author: a.cherif $
 */
class Amhsoft_Soap_Transport extends nusoap_base {
   ...
   * @access public
   */
  function Amhsoft_Soap_Transport($url, $curl_options = NULL, $use_curl = false){
    parent::nusoap_base();
