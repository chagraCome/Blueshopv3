...
class Amhsoft_Rest_Client {
     ...
     /**
      * Creates the RESTAmhsoft_Rest_Client
      * @param string $url=null [optional]
      * @return Amhsoft_Rest_Client
      */
     public static function createAmhsoft_Rest_Client($url=null) {
         $client = new Amhsoft_Rest_Client ;
         if($url != null) {
             $client->setUrl($url);
         }
         return $client;
     ...
     public static function call($method,$url,$body,$user=null,$pwd=null,$contentType=null) {
         return self::createAmhsoft_Rest_Client($url)
             ->setParameters($body)
             ->setMethod($method)
