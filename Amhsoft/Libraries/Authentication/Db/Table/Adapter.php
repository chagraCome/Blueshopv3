 ...
 * $Author: a.cherif $
 */
class Amhsoft_Authentication_Db_Table_Adapter extends Amhsoft_Authentication_Adapter_Abstract {
    ...
    * @param string $identityCol
    * @param string $credentialCol
    * @param string $where_clause
    * @param string $credentialHashCallBack
    */
    public function __construct($tableName = null, $identityCol = null, $credentialCol = null, $where_clause = null, $credentialHashCallBack = 'sha1') {
        $this->tableName = $tableName;
        $this->identityCol = $identityCol;
        $this->cridentialCol = $credentialCol;
        $this->cridentialHash = $credentialHashCallBack;
