...
class Amhsoft_Text_Converter_Wiki implements Amhsoft_Text_Converter_Interface{
  ...
  public function __construct($analyze = false) {
    $this->patterns = array(
        ...
        // Newlines (TO_DO: make it smarter and so that it groupd paragraphs)
        "/^(?!<li|dd).+(?=(<a|strong|em|img)).+$/mi", // Ones with breakable elements (TO_DO: Fix this crap, the li|dd comparison here is just stupid)
