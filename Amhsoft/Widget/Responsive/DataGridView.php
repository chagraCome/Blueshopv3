...
/**
 * Amhsoft_Responsive_DataGridView_Component class
 * @author Montasser Smida
 */
class Amhsoft_Widget_Responsive_DataGridView implements Amhsoft_Widget_Interface {
...
//$this->rowProPage = $this->pagination->ItemProPage;
    ...
    private function init() {
        $css = '<link href="jquery.dataTables.css" rel="stylesheet" type="text/css"/>';
        $css .='<script src="jquery.dataTables.min.js" type="text/javascript"></script>';
        $css .= '<script src = "dataTables.responsive.min.js" type = "text/javascript"></script>';
        $css .= '<link href = "dataTables.responsive.css" rel = "stylesheet" type = "text/css"/>';
        $table =$css;
        $table .='<table id="example" class="display responsive nowrap" cellspacing="0" width="100%">';
        return $table;
    }
