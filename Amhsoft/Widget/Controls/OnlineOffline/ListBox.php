 ...
 * @author Amir Cherif
 */
class Amhsoft_OnlineOffline_ListBox_Control extends Amhsoft_ListBox_Control implements Amhsoft_Widget_Interface {
    ...
    public function __construct($name, $label, $databindStringValue, $selectedValue = false, $withNullOptions = false) {
        ...
        $data = array(
            array('id' => '0', 'name' => _t('Offline')),
            array('id' => '1', 'name' => _t('Online'))
        );
