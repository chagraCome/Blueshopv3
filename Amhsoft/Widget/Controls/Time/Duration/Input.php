 ...
 * $Author: a.cherif $
 */
class Amhsoft_Time_Duration_Input_Control extends Amhsoft_Input_Control {
  ...
  public function __construct($name, $label = null, $value = null) {
    ...
    $this->Class = 'inp timedurationpicker';
    $this->Type = 'text';
    $this->setSize(10);
    $this->setMaxlength(10);
    
    if ($this->Value == '00:00' || $this->Value == null) {
      $this->Value = null;
    }else{
  ...
  public function getValue() {
    if ($this->Value == '00:00:00' || $this->Value == null) {
