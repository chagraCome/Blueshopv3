 ...
 * $Author: a.cherif $
 */
class Amhsoft_Date_Input_Control extends Amhsoft_Input_Control {
  ...
  public function __construct($name, $label = null, $value = null) {
    ...
    $this->Class = 'inp datepicker';
    $this->Type = 'text';
    $this->setSize(10);
    $this->setMaxlength(10);
    
    if ($this->Value == '0000-00-00' || $this->Value == null) {
      $this->Value = null;
    }else{
      $this->Value = Amhsoft_Locale::DateTime($this->Value, 'Y-m-d');
    }
