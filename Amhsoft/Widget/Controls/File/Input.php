...
/**
 * Amhsoft_File_Input_Control control
 */
class Amhsoft_File_Input_Control extends Amhsoft_Input_Control {
   ...
   */
  public function __construct($name, $label = null, $buttonLabel = 'Upload') {
