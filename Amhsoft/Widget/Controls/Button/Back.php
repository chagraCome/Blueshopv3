 ...
 *
 * $Id: Back.php 102 2016-01-25 21:55:57Z a.cherif $
 * $Revision: 102 $
 ...
 * @author Amir Cherif
 */
class Amhsoft_Button_Back_Control extends Amhsoft_Button_Submit_Control {

  /**
   * Construct component back button
  ...
  public function __construct($event_object, $event_method) {
    parent::__construct('top_navi_button_back', _t('Back'));
    $this->Class = 'Button Back';
