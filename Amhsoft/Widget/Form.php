 ...
 * @author Thomas Häber
 */
class Amhsoft_Widget_Form extends Amhsoft_Widget_Container implements Amhsoft_Widget_Interface {
    ...
    public function isFormValid($dataSource = null) {
        if ($dataSource == null) {
            $dataSource = Amhsoft_Data_Source::Post();
        }
