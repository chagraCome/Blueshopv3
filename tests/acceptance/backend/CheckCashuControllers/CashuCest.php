...
class CashuCest {
    ...
    // want to test Cashu Settings
    public function CashuSettings(AcceptanceTester $I) {
        $I->wantToTest('Cashu Settings');
        $I->wantTo('go to /admin.php?module=cashu&page=settings');
        $I->amOnPage('/admin.php?module=cashu&page=settings');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
