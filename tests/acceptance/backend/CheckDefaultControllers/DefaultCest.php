...
class DefaultCest {
    ...
    // want to Check portlet list
    public function Portletlist(AcceptanceTester $I) {
        $I->wantToTest('Portlet list');
        $I->wantTo('go to /admin.php?module=default&page=portlet-list');
        $I->amOnPage('/admin.php?module=default&page=portlet-list');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
    ...
    // want to Set portlet Online
    public function Online(AcceptanceTester $I) {
        $I->wantToTest('portlet Online');
        $I->wantTo('go to /admin.php?module=default&page=portlet-online&id=1');
        $I->amOnPage('/admin.php?module=default&page=portlet-online&id=1');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
    ...
    // want to Set portlet Offline
    public function Offline(AcceptanceTester $I) {
        $I->wantToTest('portlet Offline');
        $I->wantTo('go to /admin.php?module=default&page=portlet-offline&id=1');
        $I->amOnPage('/admin.php?module=default&page=portlet-offline&id=1');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
