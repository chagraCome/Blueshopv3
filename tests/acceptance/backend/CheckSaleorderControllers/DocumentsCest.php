...
class DocumentsCest {
    ...
    public function AddDocument(AcceptanceTester $I) {
        $I->wantToTest('Add new Document');
        $I->wantTo('go to /admin.php?module=saleorder&page=document-add&sale_order_id=103');
        $I->amOnPage('/admin.php?module=saleorder&page=document-add&sale_order_id=103');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
    ...
    // want to check Generate PDF
    public function GeneratePDF(AcceptanceTester $I) {
        $I->wantToTest('Generate PDF');
        $I->wantTo('go to /admin.php?module=saleorder&page=document-generate&id=103');
        $I->amOnPage('/admin.php?module=saleorder&page=document-generate&id=103');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
    ...
    public function Delete(AcceptanceTester $I) {
        $I->wantToTest('Delete document');
        $I->wantTo('go to /admin.php?module=saleorder&page=document-delete&id=52');
        $I->amOnPage('/admin.php?module=saleorder&page=document-delete&id=52');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
