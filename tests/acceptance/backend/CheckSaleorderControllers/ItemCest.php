...
class ItemCest {
    ...
    public function AddItem(AcceptanceTester $I) {
        $I->wantToTest('Add new Item');
        $I->wantTo('go to /admin.php?module=saleorder&page=item-add&sale_order_id=103');
        $I->amOnPage('/admin.php?module=saleorder&page=item-add&sale_order_id=103');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
    ...
    // want to Modify Item
    public function ModifyItem(AcceptanceTester $I) {
        $I->wantToTest('Modify Item');
        $I->wantTo('go to /admin.php?module=saleorder&page=item-modify&id=45');
        $I->amOnPage('/admin.php?module=saleorder&page=item-modify&id=45');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
    ...
    public function DeleteItem(AcceptanceTester $I) {
        $I->wantToTest('Delete Item');
        $I->wantTo('go to /admin.php?module=saleorder&page=item-delete&id=39');
        $I->amOnPage('/admin.php?module=saleorder&page=item-delete&id=39');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
