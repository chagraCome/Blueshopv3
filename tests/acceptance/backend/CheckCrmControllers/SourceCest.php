...
class SourceCest {
    ...
    public function AddSource(AcceptanceTester $I) {
        $I->wantToTest('Add New contac');
        $I->wantTo('go to /admin.php?module=crm&page=account-source-add');
        $I->amOnPage('/admin.php?module=crm&page=account-source-add');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
    ...
    // want to Check List Source
    public function ListSource(AcceptanceTester $I) {
        $I->wantToTest('List Source');
        $I->wantTo('go to /admin.php?module=crm&page=source-account');
        $I->amOnPage('/admin.php?module=crm&page=source-account');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
    ...
    // want to Modify Source
    public function ModifySource(AcceptanceTester $I) {
        $I->wantToTest('Modify Source');
        $I->wantTo('go to /admin.php?module=crm&page=account-source-modify&id=13');
        $I->amOnPage('/admin.php?module=crm&page=account-source-modify&id=13');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
    ...
    // want to Delete Source
    public function DeleteSource(AcceptanceTester $I) {
        $I->wantToTest('Delete Source');
        $I->wantTo('go to /admin.php?module=crm&page=account-source-delete&id=14');
        $I->amOnPage('/admin.php?module=crm&page=account-source-delete&id=14');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
