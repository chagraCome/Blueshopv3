...
class GroupesCest {
    ...
    public function AddGroup(AcceptanceTester $I) {
        ...
        $I->wantTo('go to /admin.php?module=user&page=group-add');
    ...
    public function ListGroup(AcceptanceTester $I) {
        ...
        $I->wantTo('go to /admin.php?module=user&page=group-list');
        $I->amOnPage('/admin.php?module=user&page=group-list');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
    ...
    public function ModifyGroup(AcceptanceTester $I) {
        ...
        $I->wantTo('go to /admin.php?module=user&page=group-modify&id=1');
        $I->amOnPage('/admin.php?module=user&page=group-modify&id=1');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $this->dontSeeAnyWarningsOrErrors($I);
    ...
    public function DeleteGroup(AcceptanceTester $I) {
        ...
        $I->wantTo('go to /admin.php?module=user&page=group-delete&id=2');
        $I->amOnPage('/admin.php?module=user&page=group-delete&id=2');
        $I->wantTo('check if page reachable');
        $I->seeResponseCodeIs(200);
        $I->wantTo('check notfound not exist in url');
        $I->dontSeeInCurrentUrl('notfound');
