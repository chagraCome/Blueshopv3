...
class RatingsCest {
    ...
    // want to Check Add Rating
    public function AddRating(AcceptanceTester $I) {
        $I->wantToTest('Add Rating');
        $I->wantTo('go to /index.php?module=rating&page=add');
        $I->amOnPage('/index.php?module=rating&page=add');
