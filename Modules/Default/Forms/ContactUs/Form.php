 ...
 * $Author: a.cherif $
 */
class Default_ContactUs_Form extends Amhsoft_Widget_Form implements Amhsoft_Widget_Interface {
  ...
  public function initializeComponents() {
    ...
    $regPanel = new Amhsoft_Widget_Panel(null, 'div');
    ...
    $this->infoPanel = new Amhsoft_Widget_Panel(null);
    $this->htmlInfo = new Amhsoft_Html_Control(_t('contact information'));

    $this->infoPanel->addComponent($this->htmlInfo);
    $gridLayout = new Amhsoft_Grid_Layout(3);

    $panel = new Amhsoft_Widget_Panel(null, 'div');
    $panel->setLayout($gridLayout);
    $panel->addComponent($this->infoPanel);

    $panel->addComponent(new Amhsoft_Html_Control('&nbsp;&nbsp;&nbsp;'));
