 ...
 *
 * $Id: Footer.php 446 2016-02-19 13:41:32Z imen.amhsoft $
 * $Rev: 446 $
 * @package    Setting
...
class Setting_Backend_Template_Print_Footer_Controller extends Amhsoft_System_Web_Controller {
  ...
  public function __initialize() {
    ...
    $footerTextArea = new Amhsoft_TextArea_Wysiwyg_Control('footer', _t('Footer'));
    $footerTextArea->DataBinding = new Amhsoft_Data_Binding('footer');
    ...
    $this->headerTemplateForm->addComponent($footerTextArea);
    $this->headerTemplateForm->addComponent($submitButton);
    $this->getView()->setMessage(_t('Edit footer template'), View_Message_Type::INFO);
