...
class Setting_Backend_Template_Email_Modify_Controller extends Amhsoft_System_Web_Controller {

  /** @var Setting_Template_Email_Form $emailTemplateForm */
  protected $emailTemplateForm;

  /** @var Setting_Template_Email_Model $emailTemplateModel */
  ...
  public function __initialize() {
    $this->emailTemplateForm = new Setting_Template_Email_Form('email_form', 'POST');
    $this->getView()->setMessage(_t('Edit Email template'), View_Message_Type::INFO);
    ...
    if (!$this->emailTemplateModel instanceof Setting_Template_Email_Model) {
      die('Requested Email template not found');
    }
