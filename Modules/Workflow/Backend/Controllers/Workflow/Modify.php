 ...
 * $Author: Montasser $
 */
class Workflow_Backend_Workflow_Modify_Controller extends Amhsoft_System_Web_Controller {
  ...
  public function __initialize() {
    $this->workFlowForm   = new Workflow_Form('project_form', 'POST');
    $this->getView()->setMessage(_t('Edit Workflow'), View_Message_Type::INFO);
