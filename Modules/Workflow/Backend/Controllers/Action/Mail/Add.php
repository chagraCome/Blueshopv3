 ...
 * $Author: Montasser $
 */
class Workflow_Backend_Action_Mail_Add_Controller extends Amhsoft_System_Web_Controller {
  ...
  public function __initialize() {
    ...
    $this->workFlowForm = new Workflow_Action_Mail_Form('$workFlowForm_form', 'POST');
    $this->workFlowModel = new Workflow_Action_Mail_Model();
