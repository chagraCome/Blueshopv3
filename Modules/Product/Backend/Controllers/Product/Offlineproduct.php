 ...
 *
 * $Id: Offlineproduct.php 112 2016-01-26 13:50:57Z a.cherif $
 * $Rev: 112 $
 * @package    Product
 ...
 * $Author: a.cherif $
 */
class Product_Backend_Product_Offlineproduct_Controller extends Amhsoft_System_Web_Controller {
  ...
  public function __initialize() {
    ...
    $this->productModelAdapter->where('online = 0');
  ...
  public function __default() {
    $this->getView()->setMessage(_t('List Offline Products'), View_Message_Type::INFO);
  }
