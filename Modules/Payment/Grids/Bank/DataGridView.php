 ...
 * $Author: a.cherif $
 */
class Payment_Bank_DataGridView extends Amhsoft_Widget_DataGridView {
  ...
  public function initializeComponents() {
    ...
    $this->editCol = new Amhsoft_Link_Control(_t('Edit'), '?module=payment&page=bank-modify');
    ...
    $this->deleteCol = new Amhsoft_Link_Control(_t('Delete'), '?module=payment&page=bank-delete');
