...
class Backup_DataGridView extends Amhsoft_Widget_DataGridView {
  /*
   * Grid Construct
   */
  ...
  public function initializeComponents() {
    ...
    $editCol = new Amhsoft_Link_Control(_t('Restore'), '?module=backup&page=restore');
    $editCol->DataBinding = new Amhsoft_Data_Binding('name');
    $editCol->Class = 'edit';
    $editCol->setWidth(80);
    $downloadCol = new Amhsoft_Link_Control(_t('Download'), '?module=backup&page=download');
    $downloadCol->DataBinding = new Amhsoft_Data_Binding('name');
    $downloadCol->Class = 'download';
    $downloadCol->setWidth(80);
    $delCol = new Amhsoft_Link_Control(_t('Delete'), '?module=backup&page=delete');
