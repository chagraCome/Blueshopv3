 ...
 *
 * $Id: Panel.php 455 2016-02-24 12:38:27Z imen.amhsoft $
 * $Rev: 455 $
 * @package    Saleorder
 ...
 * $Author: imen.amhsoft $
 */
class Saleorder_Panel extends Amhsoft_Widget_Panel {
  ...
  public function initializeComponents() {
    ...
    $layout->setWidth(500);
    $panelInformation = new Amhsoft_Widget_Panel(_t('Sales Order Information'));
    ...
    //$panelInformation->addComponent($this->paymentLabel);
