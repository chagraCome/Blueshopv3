 ...
 * $Author: a.cherif $
 */
class Saleorder_DataGridView extends Amhsoft_Widget_DataGridView {
    ...
    public function initializeComponents() {
        ...
        $nameCol = new Amhsoft_Link_Control(_t('Name'), 'admin.php?module=saleorder&page=saleorder-details');
