 ...
 *
 * $Id: Details.php 373 2016-02-10 08:50:52Z imen.amhsoft $
 * $Rev: 373 $
 * @package    Saleorder
 * @copyright  2006-2014 (c) AMHSOFT e.K. (Web & Software Solutions) Germany (http://www.amhsoft.com)
 * @license    AMHSHOP is a commercial software
 * $Date: 2016-02-10 09:50:52 +0100 (mer., 10 févr. 2016) $
 * $LastChangedDate: 2016-02-10 09:50:52 +0100 (mer., 10 févr. 2016) $
 * $Author: imen.amhsoft $
...
class Saleorder_Backend_Saleorder_Details_Controller extends Amhsoft_System_Web_Controller {
  ...
  protected function handleSelectedInvoice() {
   ...
   public function loadFormDataGridView() {
    ...
    $dataGridView = new Form_DataGridVeiw(16);
