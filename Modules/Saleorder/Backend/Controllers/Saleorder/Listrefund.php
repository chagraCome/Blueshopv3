 ...
 *
 * $Id: Listrefund.php 112 2016-01-26 13:50:57Z a.cherif $
 * $Rev: 112 $
 * @package    Saleorder
...
class Saleorder_Backend_Saleorder_Listrefund_Controller extends Amhsoft_System_Web_Controller {
    ...
    public function __initialize() {
        ...
        $this->saleOrderModelAdapter->where('sale_order_state_id = ?', Saleorder_State_Model::REFUNDED);
        $this->saleOrderDataGridView = new Saleorder_Refund_DataGridView();
        ...
        $this->getView()->setMessage(_t('List Sales orders Refund'), View_Message_Type::INFO);
    }
