 ...
 * $Author: a.cherif $
 */
class Modules_Paypal_Backend_Boot extends Amhsoft_System_Module_Abstract {
  ...
  public function onInitMenuContainer(Amhsoft_System $system) {
    if (Amhsoft_System_Module_Manager::isModuleInstalled('Payment')) {
      ...
      $admin->AddItem(new Amhsoft_Widget_Menu_Item(_t("Manage Paypal Settings"), "admin.php?module=paypal&page=settings"));
    }
  }
  ...
  public function onInstall(Amhsoft_System $system) {
    ...
    $paymentMethod->setDescription("Paypal Payement Method");
    $paymentMethod->setModulename('Paypal');
  ...
  public function afterInstall(Amhsoft_System $system) {
    Amhsoft_Navigator::go('admin.php?module=paypal&page=settings');
  }
