 ...
 *
 * $Id: Add.php 401 2016-02-11 12:19:40Z amira.amhsoft $
 * $Rev: 401 $
 * @package    Crm
...
class Crm_Frontend_Intern_Shop_Address_Add_Controller extends Amhsoft_System_Web_Controller {
    ...
    public function __initialize() {
        $this->setBreadCrumb(array('link' => 'index.php?module=crm&page=intern-shop-address-list', 'label' => _t('Manage Addresses')))->setBreadCrumb(array('link' => 'index.php?module=crm&page=intern-shop-address-add', 'label' => _t('Add new Address')));
        ...
        $this->crmAddressModel = new Crm_Address_Model();
        $this->crmAddressModel->account_id = $auth->getObject()->id;
       // $this->getView()->setMessage(_t('Add new Address'), View_Message_Type::INFO);
    }
