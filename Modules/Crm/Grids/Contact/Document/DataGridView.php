 ...
 * $Author: a.cherif $
 */
class Crm_Contact_Document_DataGridView extends Amhsoft_Widget_DataGridView {
  ...
  public function initializeComponents() {
    $download = new Amhsoft_Link_Control(_t('Download'), '?module=crm&page=contact-document-detail');
    ...
    $delLinkCol = new Amhsoft_Link_Control(_t('Delete'), '?module=crm&page=contact-document-delete');
