 ...
 * $Author: a.cherif $
 */
class Crm_Request_Demo_Form extends Amhsoft_Widget_Form {
  ...
  public function initializeComponents() {
    ...
    $this->commerceType = new Amhsoft_Input_Control('commerce_type', _t('Commerce Type'));
    $this->commerceType->DataBinding = new Amhsoft_Data_Binding('commerce_type');
    ...
    $companyInformations->addComponent($this->commerceType);
