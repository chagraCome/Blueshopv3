 ...
 * $Author: a.cherif $
 */
class Crm_ContactUs_Form extends Amhsoft_Widget_Form implements Amhsoft_Widget_Interface {
  ...
  public function initializeComponents() {
    ...
    $regPanel = new Amhsoft_Widget_Panel(_t('Contact Form'));
    ...
    $this->infoPanel = new Amhsoft_Widget_Panel(_t('Contact Us'));
    $this->htmlInfo = new Amhsoft_Html_Control(_t('contact_text'));
