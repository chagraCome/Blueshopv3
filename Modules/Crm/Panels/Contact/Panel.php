...
/**
 * Description of ContactPanel
 *
 * @author Montasser
 */
class Crm_Contact_Panel extends Amhsoft_Widget_Panel {

  /** @var Label $companyLabel */
  public $compnayLabel;
  public $compnaywebsiteLabel;
  ...
  public function initializeComponents() {
    ...
    $layout->setWidth(600);
    $panelInformation = new Amhsoft_Widget_Panel(_t('contact Information'));
    $panelInformation->setLayout($layout);
    $this->compnayLabel = new Amhsoft_Label_Control(_t('Company '), new Amhsoft_Data_Binding('company'));
    $this->compnaywebsiteLabel = new Amhsoft_Label_Control(_t('Company Website '), new Amhsoft_Data_Binding('company_website'));
    ...
    $panelInformation->addComponent($this->compnaywebsiteLabel);
